...
export const AgreeDeleteWindow: React.FC<DeleteEmpInterface> = (props: DeleteEmpInterface) => {
  ...
  return (
    <div>
      ...
      >
        <DialogTitle id="alert-dialog-title">Подтвердите удаление сотрудника</DialogTitle>
        <DialogActions>
          <Button onClick={()=>props.setWindowOpen(false)} color="primary">
            Отмена
          </Button>
          <Button onClick={handleCloseAccept} className={classes.mainItemButton} autoFocus>
            Удалить сотрудника
          </Button>
        </DialogActions>
      </Dialog>
